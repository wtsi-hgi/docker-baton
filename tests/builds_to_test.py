...
builds_to_test = [
    ...
    (_BATON_WITH_IRODS_4_1_9_BASE, ("mercury/baton:0.17.0-with-irods-4.1.10", "0.17.0/irods-4.1.10")),
    ...
    (_BATON_WITH_IRODS_4_1_9_BASE, ("mercury/baton:devel-with-irods-4.1.10", "devel/irods-4.1.10"))
]
